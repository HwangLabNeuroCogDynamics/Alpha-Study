...
filename = _thisDir + os.sep + u'data/%s_%s_%s' % (expInfo['subject'], expName, expInfo['date'])
...
num_trials=2 #33 #2 # change later to 33
...
blocks=data.TrialHandler(stimList,1,method='random')#one repeats each, randomly assorted but each cond is completed before they recycle #change to 3
